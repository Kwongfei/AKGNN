...
parser.add_argument("--train_labelrate", help="labeled rate of training set", type=float, default=0.48)
parser.add_argument("--val_labelrate", help="labeled data of validation set", type=float, default=0.32)
...
parser.add_argument('--early_patience', type=int, default=200,
                    help='which GPU to run')
...
adj, features, labels, idx_train, idx_val, idx_test = load_new_data(args.dataset, args.train_labelrate, args.val_labelrate, args.seed)
...
for _ in range(0,10):
    ...
    print('Test ACC:', float(best_test))
